...
function ManageAssignments() {
  ...
  const fetchRoomsAndResidents = async () => {
    try {
      // Fetch rooms
      const roomsResponse = await API.get("/getrooms");
      setRooms(roomsResponse.data.allRooms);
      
      // Fetch residents
      const residentsResponse = await API.get("/getresidents");
      setResidents(residentsResponse.data.residentData);
    } catch (error) {
      console.error("Error fetching rooms or residents:", error);
    }
  };
  ...
  // Helper function to get resident name by ID
            ...
            <tbody>
              {assignments.map((assignment, index) => (
                ...
                >
                  ...
                  <td className="py-3 px-4 text-gray-800">
                    {getResidentName(assignment.residentId)}
                  </td>
                  <td className="py-3 px-4 text-gray-800">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md w-96">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    value={getRoomNumber(selectedAssignment.roomId)}
                    readOnly
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={getResidentName(selectedAssignment.residentId)}
                    readOnly
                    className="w-full border rounded p-2 mt-1 bg-gray-100"
                  />
                </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center">
            <div className="bg-white p-6 rounded-lg shadow-md w-96">
              ...
              <p className="text-gray-600">
                Are you sure you want to delete the assignment for {assignmentToDelete && getResidentName(assignmentToDelete.residentId)} in room {assignmentToDelete && getRoomNumber(assignmentToDelete.roomId)}?
              </p>
              <div className="mt-6 flex justify-end space-x-4">
                <button
...
//       const data = response.data.roomAssignments || [];
//       console.log("Processed Assignments:", data);
//       setAssignments(data);
//     } catch (error) {
//       console.error("Error fetching assignments:", error);
...
//                 >
//                   <td className="py-3 px-4 text-gray-800">
//                     {assignment.roomId?.roomNumber || "N/A"}
//                   </td>
//                   <td className="py-3 px-4 text-gray-800">
//                     {assignment.residentId?.username || "N/A"}
//                   </td>
//                   <td className="py-3 px-4 text-gray-800">
//                     {new Date(assignment.checkInDate).toLocaleDateString()}
//                   </td>
...
//                   <input
//                     type="text"
//                     value={selectedAssignment.roomId?.roomNumber || "N/A"}
//                     readOnly
...
//                   <input
//                     type="text"
//                     value={selectedAssignment.residentId?.username || "N/A"}
//                     readOnly
//                     className="w-full border rounded p-2 mt-1 bg-gray-100 cursor-not-allowed"
//                   />
//                 </div>
